...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
	...
	public AutenticacaoViaTokenFilter(TokenService tokenService,AccountRepository repository) {
		super();
	...
	private void autenticateUser(String token) {
		String UserUuid = tokenService.getIdUser(token);
		AccountEntity usuario = repository.findById(UserUuid).get();
